<p align="center">
  <img src="images/banner.png" alt="JSONBro — JSON diffs and formatting for VS Code" width="100%">
</p>

<h1 align="center">JSONBro for Visual Studio Code</h1>

<p align="center">
  <strong>Clean JSON. Clear diffs. Zero friction.</strong><br>
  A fast, focused VS Code extension for formatting and comparing JSON—without leaving your editor.
</p>
